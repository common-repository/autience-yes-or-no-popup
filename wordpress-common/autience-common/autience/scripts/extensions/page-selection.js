angular.module("autienceAdmin")
    .controller("pageSelectionController", ['$scope', '$base64', '$http','$modal',
        function($scope, $base64, $http,$modal) {
            if (!$scope.settings.smart['page-selection']) {
                $scope.settings.smart['page-selection'] = {
                    hide: [],
                    show: []
                }
            }
            ...
            $scope.selectionChanged = function(selectedPost) {
                ...
                removeItemFromArray($scope.json[$scope.smart.pageSelection.specific], selectedPost.originalObject)
            ...
            $scope.removeFromList = function(list, item) {
                ...
                insertIntoArray($scope.json[$scope.smart.pageSelection.specific], item)
            }
